...
<html>
	...
	<body>
		...
		<div class="nav">
			<ul>
				<li><a href="" style="background-color:lightgray;color:#010145">Make Bill</a></li>
			...
			<div class="data">
				<form action="addmedicine.php" method="post" onsubmit="alert('Drug record added.');">
					<table align="center" ce>	
						...
						<tr>
							<td height="50px" align="right" colspan="2"><input class="subbtn" type="submit" value="start billing"></td>
						</tr>
					</table>
				</form>
