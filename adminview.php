...
<html>
	...
	<body>
		...
		<div class="nav">
			<ul>
				<li><a href="" style="background-color:lightgray;color:#010145">Requests</a></li>
				<li><a href="adminview2.php">Delete Account</a></li>
			</ul>
		</div>
		<div class="content">
			<h1>Requests</h1>
					 ...
					 {  
						echo "
								<tr>
									...
									?>
									<td align="center">
										<a href="accept.php/?id=<?php echo $row['id'];?>"><img src="accept.png" width="20px" height="20px"></a>
										<a href="reject.php/?id=<?php echo $row['id'];?>"><img src="reject.png" width="20px" height="20px"></a>
									</td>
									</tr>
